...
vermessenen Punktes auslesen. Dies diente der Korrektur des DGM1 aus Brandenburg, Mecklenburg-Vorpommern und Niedersachsen für die jeweiligen Projektflächen.
Der Abgleich kann mit der Funktion "Sample raster values" in QGIS durchgeführt werden. Mit dem folgenden Code werden die Ergebnisse 
...
Weiter unten befindet sich ein weiterer, zeitweise angewandter alternativer Methodikansatz in PyQGIS, der aktuell abgelöst wurde.
...
Dieses alternative Skript soll die Werte eines DGM1_Rasters an der Stelle eines im Gelände 
