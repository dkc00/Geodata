...
korrekturpfad_zur_suche = r"C:/Users/Daniel Koch"

def layer_relinker(lyr_name, korrekturpfad_zur_suche):
    ...
    # hier wird geprüft, ob der layer valid ist, und sonst der richtige pfad gesucht
        ...
        for root, dirs, files in os.walk(korrekturpfad_zur_suche): 
            # per os.walk Befehl wird im angegebenen korrekturpfad_zur_suche gesucht
        ...
        # neu eingeladen werden. 
            ...
            print(f"Keine Datei für '{lyr_name}' unter {korrekturpfad_zur_suche} gefunden.")
